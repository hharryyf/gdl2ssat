...
To run the baseline encoding, just add a ```-b``` flag in the above commands.

```extg2ssat_turn_v2.py``` is an optimised version of the encoding covered in the paper, still under development.
